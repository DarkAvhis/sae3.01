...
public class AssociationObjet extends LiaisonObjet {
    ...
    public boolean getUnidirectionnel() {
        return this.estUnidirectionnel;
    }

    public String getRoleOrig() {
        return this.roleOrig;
    }
    ...
    public int getRoleOrigOffsetAlong() {
        return this.roleOrigOffsetAlong;
    }

    public int getRoleOrigOffsetPerp() {
        return this.roleOrigOffsetPerp;
    }

    public int getRoleDestOffsetAlong() {
        return this.roleDestOffsetAlong;
    }

    public int getRoleDestOffsetPerp() {
        return this.roleDestOffsetPerp;
    }
