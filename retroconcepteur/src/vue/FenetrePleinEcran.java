...
/**
 * Fenêtre plein écran pour afficher la classe complète
 * avec tous ses attributs et méthodes.
 *
...
public class FenetrePleinEcran extends JFrame
{
    ...
    /**
     * Affiche tous les détails de la classe
     * (attributs et méthodes complets).
     */
