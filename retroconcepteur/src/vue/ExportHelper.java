...
public class ExportHelper
{
    ...
    public static void exportDiagram(FenetrePrincipale vuePrincipale)
    {
        ...
        chooser.setFileFilter(new javax.swing.filechooser.FileNameExtensionFilter("Image PNG", "png"));
        ...
        try
        {
            ExportHelper.exportComponent( vuePrincipale.getPanneauDiagramme(), fichier );
            JOptionPane.showMessageDialog( vuePrincipale, 
                                           "Le diagramme a été exporté avec succès.\n\nFichier :\n" + 
                                           fichier.getAbsolutePath(),"Export réussi", JOptionPane.INFORMATION_MESSAGE);
        } 
        catch (IOException e)
        {
            JOptionPane.showMessageDialog(vuePrincipale,
