...
public class LiaisonVue 
{
    ...
    public int         getRoleOrigOffsetAlong() { return roleOrigOffsetAlong; }
    public int         getRoleOrigOffsetPerp () { return roleOrigOffsetPerp ; }
    public int         getRoleDestOffsetAlong() { return roleDestOffsetAlong; }
    public int         getRoleDestOffsetPerp () { return roleDestOffsetPerp ; }
    ...
    public void setMultipliciteOrig(String mult      ) { this.multipliciteOrig = (mult       != null) ? mult       : "" ; }
    public void setMultipliciteDest(String mult      ) { this.multipliciteDest = (mult       != null) ? mult       : "" ; }
    public void setRoleOrig        (String role      ) { this.roleOrig         = (role       != null) ? role       : "" ; }
    public void setRoleDest        (String role      ) { this.roleDest         = (role       != null) ? role       : "" ; }  
    public void setProprietes      (String proprietes) { this.proprietes       = (proprietes != null) ? proprietes : "" ; }
    public void setContrainte      (String contrainte) { this.contrainte       = (contrainte != null) ? contrainte : "" ; }
}